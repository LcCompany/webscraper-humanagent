...
user_input_url = st.text_input("Voer de website in die je wilt scrapen.</div> Het script zal deze website vervolgens bezoeken en alle pagina's binnen hetzelfde domein scrapen om tekst te verzamelen.", "")
